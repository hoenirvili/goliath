...
//     SECTION("When the virtual memory is set but the engine fails to
//     initialise")
//     {
...
//         logger::custom_creation(std::bind(&fake_output_streamer::writer,
//         &fos,
//                                           std::placeholders::_1));
...
//     SECTION("When the state is initialised and the logger is at iteration >
//     0")
//     {
//         auto vm = virtual_memory();
//         vm.enable_log_name();
...
//         auto params = std::make_unique<custom_params>(
//           0x55232288, "CALL 0x5521323", CallType, 4, 0x5521323, 0x55232288 +
//           4);
//         auto layers = plugin_layer({{1, "PluginOne", nullptr, nullptr},
//                                     {2, "PluginTwo", nullptr, nullptr}});
...
//                         {1, "APIReporter", nullptr, "External windows
//                         api"}});
